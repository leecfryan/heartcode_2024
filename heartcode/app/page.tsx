...
export default function Home() {
  return (
    <div className="w-[calc(100vw-50px)] font-mono">
      ...
      <h1 className="flex items-center justify-center font-semibold text-2xl mb-4">WHAT DIFFERENCE DOES IT MAKE?</h1>
      ...
      <h1 className="flex items-center justify-center font-semibold mt-8 mb-2 text-2xl">WHY PEOPLE DO DRUGS?</h1>
      ...
      <div className="flex items-center justify-center font-mono">
        ...
        <div className="mx-1">
          <HoverCard>
            <HoverCardTrigger className="text-xl">Inluence and Upbringing,</HoverCardTrigger>
            <HoverCardContent>
